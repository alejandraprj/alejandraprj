...
\begin{document}
  ...
  \begin{itemize}[itemsep=-.4em, leftmargin=1em]\vspace{-2mm}
    \item Oversaw and collaborated with 8 members on initiatives to promote diversity and inclusion. Organized events to provide more resources to underrepresented groups.
  \end{itemize}
