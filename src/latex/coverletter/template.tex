...
% personal data
\name{Alejandra J.}{Perea Rojas}
\title{Alejandra's Cover Letter}                  
    % optional, remove / comment the line if not wanted
\address{25 Rome Ave}{Bedford Hills, NY 10507}{United States}
...
\phone[mobile]{914-888-7334}                   
    % optional, remove / comment the line if not wanted
%\phone[fixed]{+2~(345)~678~901}                   
     % optional, remove / comment the line if not wanted
%\phone[fax]{+3~(456)~789~012}                      
    % optional, remove / comment the line if not wanted
\email{aperearojas@college.harvard.edu}                               
    % optional, remove / comment the line if not wanted
\homepage{www.alejandraprj.com}                         
    % optional, remove / comment the line if not wanted
